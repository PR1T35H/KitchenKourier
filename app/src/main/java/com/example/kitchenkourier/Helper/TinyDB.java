...
public class TinyDB {
    ...
    public ArrayList<KathiDomain> getListObject(String key,int y){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<KathiDomain> playerList =  new ArrayList<KathiDomain>();

        for(String jObjString : objStrings){
            KathiDomain player  = gson.fromJson(jObjString, KathiDomain.class);
            playerList.add(player);
        }
        return playerList;
    }
    public ArrayList<QuenchDomain> getListObject(String key, int y,int z){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<QuenchDomain> playerList =  new ArrayList<QuenchDomain>();

        for(String jObjString : objStrings){
            QuenchDomain player  = gson.fromJson(jObjString,  QuenchDomain.class);
            playerList.add(player);
        }
        return playerList;
    }
    public ArrayList<HotspotDomain> getListObject(String key, int y, int z,int x){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<HotspotDomain> playerList =  new ArrayList<HotspotDomain>();

        for(String jObjString : objStrings){
            HotspotDomain player  = gson.fromJson(jObjString,  HotspotDomain.class);
            playerList.add(player);
        }
        return playerList;
    }
    public ArrayList<NonVegKitchenDomain> getListObject(String key, int y, int z, int x,int u){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<NonVegKitchenDomain> playerList =  new ArrayList<NonVegKitchenDomain>();

        for(String jObjString : objStrings){
            NonVegKitchenDomain player  = gson.fromJson(jObjString,  NonVegKitchenDomain.class);
            playerList.add(player);
        }
        return playerList;
    }
    ...
    public void putListObject(String key, ArrayList<KathiDomain> playerList,int temp){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(KathiDomain player: playerList){
            objStrings.add(gson.toJson(player));
        }
        putListString(key, objStrings);
    }
    public void putListObject(String key, ArrayList<QuenchDomain> playerList,int temp,int x){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(QuenchDomain player: playerList){
            objStrings.add(gson.toJson(player));
        }
        putListString(key, objStrings);
    }
    public void putListObject(String key, ArrayList<HotspotDomain> playerList,int temp,int x,int y){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(HotspotDomain player: playerList){
            objStrings.add(gson.toJson(player));
        }
        putListString(key, objStrings);
    }
    public void putListObject(String key, ArrayList<NonVegKitchenDomain> playerList,int temp,int x,int y,int u){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(NonVegKitchenDomain player: playerList){
            objStrings.add(gson.toJson(player));
        }
        putListString(key, objStrings);
    }
