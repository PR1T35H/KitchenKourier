...
public class QuenchMenuDetailActivity extends AppCompatActivity {
    private TextView addToCartBtn;
    private TextView titleTxt,feeTxt,numberOrderTxt;
    private ImageView plusBtn,minusBtn,picFood;
    private QuenchDomain object;
    int numberOrder=1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quench_menu_detail);
    ...
    private void getBundle() {
        object=(QuenchDomain) getIntent().getSerializableExtra("object");
