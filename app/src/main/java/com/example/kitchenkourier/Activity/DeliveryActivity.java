...
public class DeliveryActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        lastQuery.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(DeliveryActivity.this, "Sorry", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        deliveryTxt = (EditText) findViewById(R.id.address);
        ...
        submitBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String addressTxt = deliveryTxt.getText().toString();
                if(!addressTxt.isEmpty()){
                    startActivity(new Intent(DeliveryActivity.this,OrderPlacedActivity.class));
                    overridePendingTransition(R.anim.slide_in_right,R.anim.slide_out_left);
                }
                else{
                    Toast.makeText(DeliveryActivity.this, "Enter your Delivery Location", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void bottomNavigation(){
        ...
        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(DeliveryActivity.this,CartListActivity.class));
                overridePendingTransition(R.anim.slide_in_right,R.anim.slide_out_left);
            }
        });
        ...
        supportBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(DeliveryActivity.this,SupportQueryActivity.class) );
                overridePendingTransition(R.anim.slide_in_right,R.anim.slide_out_left);
