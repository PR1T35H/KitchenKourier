...
public class NonVegKitchenMenuDetailActivity extends AppCompatActivity {
    private TextView addToCartBtn;
    private TextView titleTxt,feeTxt,numberOrderTxt;
    private ImageView plusBtn,minusBtn,picFood;
    private NonVegKitchenDomain object;
    int numberOrder=1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_non_veg_kitchen_menu_detail);
    ...
    private void getBundle() {
        object=(NonVegKitchenDomain) getIntent().getSerializableExtra("object");
